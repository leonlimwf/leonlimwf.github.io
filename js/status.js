...
function loadLastUpdated() {
    ...
    document.getElementById('update').innerHTML = "Last Updated " + final
}
...
function loadAvailability() {
    ...
    if (dayOfWeek > 0 && dayOfWeek < 6) {
        if (hour > 9 && (hour < 15 && minutes > 0)) {
            ...
            document.getElementById('status-text').innerHTML = `<i class="fas fa-school"></i> In School`
        } else {
            document.getElementById('availability').innerHTML = "Available"
            document.getElementById('small-rectangle').style.backgroundColor = "limegreen"
            document.getElementById('status-text').innerHTML = `<i class="fas fa-signal"></i> Online`
        }
    } else {
        document.getElementById('availability').innerHTML = "Available"
        document.getElementById('small-rectangle').style.backgroundColor = "limegreen"
